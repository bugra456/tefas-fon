...
<h3>🤔 Hangisini Seçmelisin?</h3>
<p><strong style="color:var(--grn)">✓ 3 dönemin hepsinde geçen (3/3)</strong> fonlar en güvenilir gösterge.
Son 1, 3 ve 6 ayın hepsinde mevduatı geçen bir fon, tutarlı performans sergilemiş demektir.</p>
<p><strong style="color:var(--org)">✓ Beklenen aylık fark ne kadar büyük olursa</strong>,
gelecekte mevduatı geçme ihtimali o kadar yüksek. Ama fark büyükse riski de kontrol et.</p>
<p><strong style="color:var(--red)">✗ Sadece puan yüksek diye seçme.</strong>
Puan yüksek = düşük riskli ve geçmişte iyi performans. Ama Risk 1 fon %3.50 getiriyorsa,
Risk 4 fon %4.50 getiriyorsa → senin için Risk 4 daha anlamlı olabilir (fark büyük).</p>
<p><strong>Öneri:</strong> Önce yukarıdaki risk filtresinden "Orta (3-4)" seç.
Orta riskli, tutarlı şekilde mevduatı geçen fonları gör. Sonra aralarından
en yüksek farkı (+%) olanı seç.</p>
</div>
